...
---@return boolean Check if object as a buff of a specific type.
function c_buff_cache:has_buff_of_type(object_index, type) end

---@param object_index number
---@return boolean Checks if the object has a hard stun, charm, fear, knockup, knockback, sleep or suppression.
function c_buff_cache:has_hard_cc(object_index) end

---@param object_index number
---@return boolean Checks if the object is immobile.
function c_buff_cache:is_immobile(object_index) end

---@param object_index number
---@return boolean Check whether the object/champion can currently cast.
function c_buff_cache:can_cast(object_index) end

---@param object_index number
---@return table<c_buff> Returns all cached buffs for an object.
