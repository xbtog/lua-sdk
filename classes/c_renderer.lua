...
---@param color color
---@param thickness number
---@return nil Draws a line in 3D space.
...
---@param radius number
---@param segments number
---@return nil Draws a filled circle.
...
---@param segments number
---@param thickness number
---@return nil Draws a circle in 3D space.
...
---@param bottom vec2
---@param color color
---@return nil Draws a filled triangle.
...
---@return nil Draws a texture as a sprite.
...
---@param segments number
---@param thickness number
---@return nil Draws a circle on the minimap.
